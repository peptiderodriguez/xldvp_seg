...
- **Python:** 3.11 (3.10 and earlier no longer supported — several scverse deps require ≥3.11; 3.12+ not supported because black formats differently)
...
- All coordinates are **[x, y]** (horizontal, vertical). See [Coordinate System](COORDINATE_SYSTEM.md).
...
5. **Add a changelog entry** under the `[Unreleased]` section in the [Changelog](changelog.md).
