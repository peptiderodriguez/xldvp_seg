...
**Step 4 — Recommend a pipeline.** Based on channels:
- Has BTX channel → "This looks like an NMJ slide. Use `--cell-type nmj --channel <BTX_index>`"
- Has SMA + CD31 → "This looks like a vessel slide. Use `--cell-type vessel`"
- Has nuclear + marker → "Generic cell detection with Cellpose. Use `--cell-type cell --cellpose-input-channels <cyto>,<nuc>`"
