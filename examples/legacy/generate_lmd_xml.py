...
def create_lmd_xml(
    export_data: dict,
    reference_crosses: list[dict] | None = None,
...
def main(output_dir: Path, image_width: int | None = None, image_height: int | None = None):
    print("=" * 70)
    ...
    n_in_clusters = export_data.get("summary", {}).get(
        "n_detections_in_clusters", export_data.get("summary", {}).get("n_nmjs_in_clusters", 0)
    )
    ...
    print("\nNext steps:")
    print("  1. Place reference crosses in Napari (if not done)")
    print("  2. Transfer shapes.xml to LMD computer")
    print("  3. Load in Leica LMD software")
    print("  4. Calibrate using reference crosses")
    print("  5. Start collection!")
    print("=" * 70)
...
if __name__ == "__main__":
    ...
    main(args.output_dir, image_width=args.image_width, image_height=args.image_height)
