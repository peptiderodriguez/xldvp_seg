...
# Run this AFTER step1_compute_norm_params.sbatch completes
...
echo "============================================================"
echo "Submitting 8 parallel jobs with GLOBAL normalization"
echo "============================================================"
...
echo "============================================================"
echo ""
echo "Each job will apply the SAME global normalization parameters"
echo "computed from all 16 slides."
echo ""
