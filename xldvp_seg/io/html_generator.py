"""Class-based HTML generator (HTMLPageGenerator).
...
MK/HSPC batch export functions have moved to ``html_batch_export.py`` and are
...
# Backward compatibility -- these functions moved to html_batch_export.py
from xldvp_seg.io.html_batch_export import (  # noqa: F401, E402
    create_export_index,
