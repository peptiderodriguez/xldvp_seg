...
> Entries after 2026-03-25 live in [docs/changelog.md](docs/changelog.md). The
> root CHANGELOG.md is retained for 2.0.0 release history; for April 2026 and
> onward (MS queue builder, preprocessing caches, RGB brightfield, manifold
> sampling, tile-overlap default change, etc.) see the docs-site changelog.
