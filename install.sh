...
echo ""
echo "Usage:"
echo "  # MK/HSPC segmentation (single GPU):"
echo "  python run_unified_FAST.py --czi-paths /path/to/*.czi --output-dir /path/to/output"
echo ""
echo "  # MK/HSPC with multi-GPU (4 GPUs):"
echo "  python run_unified_FAST.py --czi-paths /path/to/*.czi --output-dir /path/to/output --multi-gpu --num-gpus 4"
echo ""
echo "  # NMJ segmentation:"
echo "  python run_segmentation.py --czi-path /path/to/slide.czi --cell-type nmj"
echo ""
echo "  # Slurm batch job (4 GPUs):"
echo "  sbatch slurm/run_multigpu.sbatch input_files.txt /path/to/output"
echo ""
