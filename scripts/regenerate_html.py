...
def create_sample_from_contours(
    det,
    channel_arrays,
    display_channels,
    x_start,
...
def main():
    ...
    parser.add_argument("--scene", type=int, default=0, help="CZI scene index (default: 0)")
    parser.add_argument(
        "--tile-size",
        type=int,
        default=None,
    ...
    parser.add_argument(
        "--samples-per-page", type=int, default=300, help="Samples per HTML page (default: 300)"
    )
    parser.add_argument(
        "--sort-by",
        default="area",
